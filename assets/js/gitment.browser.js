...
var NOT_INITIALIZED_ERROR = exports.NOT_INITIALIZED_ERROR = new Error('评论没有初始化');
...
function renderComments(_ref2, instance) {
  ...
  if (error) {
    ...
    emptyBlock.innerText = '还没有评论,快来抢沙发哦~';
